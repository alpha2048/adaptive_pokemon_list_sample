...
class _$MainViewModelDataTearOff {
  ...
  Loaded loaded({List<PokemonResponse> response = const []}) {
    return Loaded(
      response: response,
    );
  }
...
class _$Loaded implements Loaded {
  const _$Loaded({this.response = const []});
...
abstract class Loaded implements MainViewModelData {
  ...
  List<PokemonResponse> get response => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
